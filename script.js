...
const helpContent = {
	shellType: {
		header: 'Loại Pháo',
		body: 'Loại pháo hoa sẽ được phóng. Chọn "Ngẫu nhiên" để có một loại tốt!'
	},
	shellSize: {
		header: 'Kích cỡ',
		body: 'Kích thước của pháo hoa. Được mô phỏng theo kích cỡ đạn pháo hoa thực, những quả đạn pháo lớn hơn có những vụ nổ lớn hơn với nhiều ngôi sao hơn và đôi khi hiệu ứng phức tạp hơn. Tuy nhiên, các shell lớn hơn cũng đòi hỏi nhiều sức mạnh xử lý hơn và có thể gây ra hiện tượng trễ.'
	},
	quality: {
		header: 'Đồ họa',
		body: 'Chất lượng đồ họa tổng thể. Nếu hoạt ảnh chạy không trơn tru, hãy thử giảm chất lượng xuống. Chất lượng cao làm tăng đáng kể lượng tia lửa được hiển thị và có thể gây ra hiện tượng trễ.'
	},
	skyLighting: {
		header: 'Ánh sáng',
		body: 'Chiếu sáng nền khi pháo hoa nổ. Nếu nền trông quá sáng trên màn hình của bạn, hãy thử đặt nó thành "Dim" hoặc "None".'
	},
	scaleFactor: {
		header: 'Tỉ Lệ',
		body: 'Cho phép thu nhỏ kích thước của tất cả pháo hoa, về cơ bản là di chuyển bạn đến gần hoặc xa hơn. Đối với kích thước vỏ lớn hơn, có thể thuận tiện để giảm tỷ lệ một chút, đặc biệt là trên điện thoại hoặc máy tính bảng.'
	},
	autoLaunch: {
		header: 'Tự động',
		body: 'Tự động phóng các chuỗi pháo hoa. Ngồi lại và thưởng thức chương trình, hoặc vô hiệu hóa để có toàn quyền kiểm soát.'
	},
	finaleMode: {
		header: 'Chế Độ đặc biệt',
		body: 'Bắn những chùm pháo hoa dữ dội. Có thể gây ra độ trễ. Yêu cầu bật "Auto Fire".'
	},
	hideControls: {
		header: 'Ẩn phím điều khiển',
		body: 'Ẩn các điều khiển mờ dọc theo đầu màn hình. Hữu ích cho ảnh chụp màn hình hoặc chỉ là một trải nghiệm liền mạch hơn. Trong khi bị ẩn, bạn vẫn có thể nhấn vào góc trên bên phải để mở lại menu này.'
	},
	fullscreen: {
	...
	longExposure: {
		header: 'Open Shutter',
		body: 'Hiệu ứng thử nghiệm giúp lưu giữ các vệt sáng dài, tương tự như để màn trập máy ảnh mở.'
	}
};
...
function init() {
	...
	setOptionsForSelect(appNodes.skyLighting, [
		...
		{ label: 'Mờ Mờ', value: SKY_LIGHT_DIM },
